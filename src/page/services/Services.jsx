    ...
    <div className="bg-gray-200 flex justify-center" >
      ...
      <div className="hidden lg:block lg:relative">
        <div className="xl:max-w-lg xl:ml-auto lg:w-full">
          <img className=" z-30 top-0 right-0 rounded-lg shadow-xl sm:mt-8 sm:h-64 sm:w-full sm:object-cover lg:object-cover lg:w-full sm:object-center lg:block" src={beach_image} alt="Woman workcationing on the beach" />
